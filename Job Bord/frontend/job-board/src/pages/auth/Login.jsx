...
function Login() {
  ...
  return (
    <section className="h-screen flex justify-center items-center bg-white">
      <div className="flex h-fit flex-col gap-6 items-center bg-gray-300 shadow-lg rounded-lg p-8 max-w-md">
        {/* Header */}
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-6 w-full">
          ...
          <input
            ...
            placeholder="Email"
            ref={email}
            className="h-12 p-2 border rounded-md focus:ring-2 focus:ring-blue-400 outline-none"
          />
          <div className='flex'>
              <input
              ...
              ref={password}
              className="h-12 w-full p-2 border rounded-md focus:ring-2 focus:ring-blue-400 outline-none"
              />
          ...
          <button
            type="submit"
            className={`h-12 bg-blue-500 hover:bg-blue-600 text-xl pb-5 text-white font-semibold py-2 rounded-md transition ${
