      ...
      <form onSubmit={handleRoleSubmit}>
        <FormControl component="fieldset">
          <FormLabel
            component="legend"
            sx={{
              '&.Mui-focused': { color: '#fff' }, // Green when checked
            }}>
            I am an/a:</FormLabel>
          <RadioGroup value={role} onChange={(e) => setRole(e.target.value)}>
            <FormControlLabel value="Employer" control={<Radio
              sx={{
                '&.Mui-checked': { color: '#fff' }, // Green when checked
              }}
            />} label="Employer" />
            <FormControlLabel value="Job Seeker" control={<Radio
              sx={{
                '&.Mui-checked': { color: '#fff' }, // Green when checked
              }}
            />} label="Job Seeker" />
